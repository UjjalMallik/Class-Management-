                ...
                <CardContent className="p-4">
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-start gap-3 min-w-0 flex-1">
                      <div className="shrink-0 flex items-center justify-center h-9 w-9 rounded-full bg-blue-50 dark:bg-[#1c1d29] text-blue-600 dark:text-[#14b8a6] p-2">
                        <Megaphone className="h-4 w-4" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <h3 className="font-bold text-gray-800 dark:text-[#e5e7eb] text-lg leading-snug">
                          {n.title}
                        </h3>
                        <p className="text-gray-600 dark:text-[#9ca3af] mt-2 text-sm whitespace-pre-wrap leading-relaxed line-clamp-2">
                          {n.content}
                        </p>
                      </div>
                    </div>
                    <div className="flex flex-col items-end gap-2 shrink-0">
                      <span className="text-xs text-gray-400 dark:text-[#9ca3af] font-medium flex items-center gap-1 whitespace-nowrap">
